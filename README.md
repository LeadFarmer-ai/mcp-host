...
🙏 _Heavily_ inspired by the [article](https://neon.tech/blog/building-a-cli-client-for-model-context-protocol-servers) & example code published by [Neon](https://neon.tech/). 
